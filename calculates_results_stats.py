...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic = {
        ...
        'n_correct_dogs': 0,
        'n_correct_notdogs': 0,
        'n_correct_breed': 0,  # Correct breed is specifically for dogs
    }

    # Count the number of pet images identified as dogs and non-dogs, and the number of matches
    for key in results_dic:
        # Unpack the five expected items
        ...
        if pet_is_dog == 1:
            ...
            if classifier_is_dog == 1:
                ...
                # Check if the breed was correctly classified (pet label matches classifier label)
                if match == 1:  # This implies correct breed if it's a dog
